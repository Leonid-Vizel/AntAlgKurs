...
public:
	...
	const int DelayMs = 50; // Задержка поска каждой итерации в мс
	const double EvaporationRate = 0.1; // Коэффициент испарения феромонов
	const double MinPheromone = 0; // Минимальное количество феромона
	const double MaxPheromone = 0.9; // Максимальное количество феромона
	const double Alpha = 0.001; // Вес феромона
	const double Beta = 2; // Вес эвристической информации
	const double Q = 250.0; // Выледяемое количество феромона
